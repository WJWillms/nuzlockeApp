...
const soulockeTeamBuilder = () => {
    ...
    const parsedTrainerOneTeam = JSON.parse(trainerOneTeam); // array of selected Pokémon IDs
    ...
    const allValidTeams = getTeamsFromSelection(parsedTrainerOneTeam, 6, selectedOption);
    ...
    return (
        <View style={{ flex: 1 }}>
            ...
            <View style={soulockeTBStyles.spriteDisplayWrapper}>

                {/* 🏠 Home Button */}
                <View style={soulockeTBStyles.homeButtonContainer}>
                    <Pressable onPress={() => router.push('/')} style={soulockeTBStyles.homeButton}>
                        <Text style={soulockeTBStyles.homeButtonText}>Return to Home</Text>
                    </Pressable>
                </View>

                {/* Pokémon Sprites */}
                <View style={soulockeTBStyles.spriteTeamContainer}>
                    <View style={soulockeTBStyles.teamContainer}>
                        {currentTeam.map((id) => {
                            ...
                            return (
                                <View key={id} style={{ alignItems: 'center' }}>
                                    <View style={soulockeTBStyles.pokemonSlot}>
                                        <Image source={sprite} style={soulockeTBStyles.sprite} />
                                        <Text style={soulockeTBStyles.name}>{pokemon.name}</Text>
                                    </View>
                                    <View
                                        style={[
                                            soulockeTBStyles.typeIconRow,
                ...
                {/* Sort Dropdown */}
                <View style={soulockeTBStyles.dropdownContainer}>
                    <Text style={soulockeTBStyles.sortHeader}>Sort Options</Text>
                    <View style={soulockeTBStyles.pickerBox}>
                        <Picker
            ...
            <View style={soulockeTBStyles.bottomSection}>
                {/* Column 1: Resistances */}
                <View style={soulockeTBStyles.column}>
                    <Text style={soulockeTBStyles.sectionHeader}>RESISTANCES</Text>

                    {Object.keys(resistanceSummary.immune).length > 0 && (
                        <View>
                            <Text style={soulockeTBStyles.subHeader}>Immunities:</Text>
                            <View style={[soulockeTBStyles.resistRow, { flexWrap: 'wrap' }]}>
                    ...
                    {Object.keys(resistanceSummary.quarter).length > 0 && (
                        <View>
                            <Text style={soulockeTBStyles.subHeader}>0.25× Resistances:</Text>
                            <View style={[soulockeTBStyles.resistRow, { flexWrap: 'wrap' }]}>
                    ...
                    {Object.keys(resistanceSummary.half).length > 0 && (
                        <View>
                            <Text style={soulockeTBStyles.subHeader}>0.5× Resistances:</Text>
                            <View style={[soulockeTBStyles.resistRow, { flexWrap: 'wrap' }]}>
                ...
                <View style={soulockeTBStyles.column}>
                    ...
                    <View style={soulockeTBStyles.chartWithButtons}>
                        {/* Radar Chart */}
                        <RadarChart
                        ...
                        {/* Buttons */}
                        <View style={soulockeTBStyles.chartButtonContainer}>
                            {chartOptions.map((entry, index) => (
                                ...
                                >
                                    <Text style={soulockeTBStyles.chartButtonText}>{entry.label}</Text>
                                </Pressable>
                            ))}
                        </View>
                    </View>
                    ...
                    {/* Stat Totals Below */}
                    <View style={soulockeTBStyles.statsTotalsContainer}>
                        {[
                            ['HP:', teamStats.hp],
                            ...
                            <View key={label} style={soulockeTBStyles.statRow}>
                                <Text style={soulockeTBStyles.statLabel}>{label}</Text>
                                <Text
                                    style={[
                                        soulockeTBStyles.statValue,
                                        label === 'Total Base Stats:' && soulockeTBStyles.statValueBold,
                                    ]}
                                >
                                    {value}
                                </Text>
                ...
                <View style={soulockeTBStyles.column}>
                    ...
                    <View>
                        ...
                        {Object.keys(weaknessSummary.x4).length > 0 && (
                            <View>
                                <Text style={soulockeTBStyles.subHeader}>4× Weaknesses:</Text>
                                <View style={[soulockeTBStyles.resistRow, { flexWrap: 'wrap' }]}>
                        ...
                        {Object.keys(weaknessSummary.x2).length > 0 && (
                            <View>
                                <Text style={soulockeTBStyles.subHeader}>2× Weaknesses:</Text>
                                <View style={[soulockeTBStyles.resistRow, { flexWrap: 'wrap' }]}>
