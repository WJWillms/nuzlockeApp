...
![Flyer Edits](/assets/readMePictures/Flyer_Edits.png)
...
![Radar Charts](/assets/readMePictures/Radar_Charts.png)
The radar charts in the stats section are interactable and can be used to show multiple pokemon at one time, a single pokemon, The entire teams stats, or variations of certain pokemon to the total of the team.
![Sprite Click](/assets/readMePictures/Sprite_Click.png)
You can click a sprite to pull up individual stats, resistances, and weaknesses for a pokemon.
![Sprite Click Full](/assets/readMePictures/Sprite_Click_Full.png)
Slowly pokemon will have their pokedex entry updated to have a more complete sprite click section. It is only on very few pokemon at the moment but it is what I want the stat section to start to look like.
